...
public abstract class AbstractStringMatchTest {
	...
	@Test
	public void testAufgabe5() {
		assertEquals(-1, matcher.firstMatch("\"Informatikerinnen und Informatiker FH - dringend gesucht\". Diese Schlagzeilen begegnen Ihnen täglich in der Presse. Mit einem Studium der Informatik können auch Sie zu den gefragten Berufspersonen gehören.", "Informatik-Studium"));
	}

	@Test
	public void testKuster() {
		assertEquals(-1, matcher.firstMatch("mastfutter muss tierisch sein", "kuster"));
	}
}
