...
public class MaxSubProblemTest {
	...
	@Test
	public void testMaxSeqStartingAt1() {
		int[] numbers = new int[] { -97, 41, -31, 59, -97, -53, -58, 26 };
		assertEquals(69, ms.maxSub(numbers));
	}
	...
	@Test
	public void testMaxSeqEndingOneBeforeEnd() {
		int[] numbers = new int[] { 31, -41, 59, 26, -53, 58, 97, -1 };
		assertEquals(187, ms.maxSub(numbers));
	}
